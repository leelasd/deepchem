...
def data_dir_f(kwargs):
  base_dir = json.loads(open('paths.json').read())['split_dir']
  return os.path.join(base_dir, "datasets_%s" % kwargs['data_length'])
